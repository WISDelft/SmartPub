...
def print_top_n_terms(n, km, num_of_cluster,vocab_frame,terms):
...
def k_means_process(num_clusters, mongo_search_string):
    """
    ...
    paragraphs = create_dataset(db=db, mongo_search_string=mongo_search_string)


    totalvocab_stemmed = []
    totalvocab_tokenized = []
    for i in paragraphs:
        allwords_stemmed = tokenize_only(i)  # for each item in 'paragraphs', tokenize
    ...
    print_top_n_terms(5,km, num_clusters,vocab_frame,terms)
