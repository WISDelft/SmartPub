...
class XmlProcessing:
  ...
  def __init__(self):
    ...
    self.num_of_access_in_acm = 0
    # add the number of access in springer to set sleep mode
    self.num_of_access_in_springer = 0
    # add the number of access in aaai to set sleep mode
    self.num_of_access_in_aaai = 0
    # add the number of access in icwsm site to set sleep mode
    self.num_of_access_in_icwsm = 0
    # add the number of access in ieee site to set sleep mode
    self.num_of_access_in_ieee = 0

    self.num_of_access = 0

    self.numOfPDFobtained = 0
    self.numOfPDFobtainedInThisSession = 0
